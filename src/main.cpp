...
uint256 hashGenesisBlock("0xc6c5b71de9b651fa3ee212596a95ede684edc25ebcd2dd4ea13dedce5d3d74f6");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Kumulcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // Kumulcoin: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // Kumulcoin: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe958d77a72e94f2410054a6165325ac50678a451d628467336c4957ad763208f");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Boxing Day 2018 @ Lui's";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04aed673bc55fce1f2855e4a19602e1787ee9c911c0faa35a7569f8ca1cf6c643874208fd9d0832cc35031227cc8834e8d77eb9dacd65f8e36b1125f8030fcdf6f") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1545935352;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084910781;

        if (fTestNet)
        {
            block.nTime    = 1545935311;
            block.nNonce   = 386498939;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x1ae984f9c0dffeb907723ec63b7a35cb82206f6cbb871958a45af0dd046eb7b2"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc2, 0xba, 0xd4 }; // Kumulcoin: increase each by adding 2 to bitcoin's value.
